...
const LocationList = ({ locations, onLocationSelect, selectedLocationId = null, isLoading = false }) => {
      ...
      <div className="flex-shrink-0 px-4 py-3 border-b border-gray-200 bg-white">
        ...
        {locations.length > 0 && (
          <div className="mt-2 text-sm text-gray-600">
            Mostrando {((currentPage - 1) * itemsPerPage) + 1} - {Math.min(currentPage * itemsPerPage, locations.length)} de {locations.length}
          </div>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {locations.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full p-8 text-center">
            ...
            <h4 className="text-lg font-medium text-gray-600 mb-2">No se encontraron ubicaciones</h4>
                      ...
                      <div className="mt-2 flex flex-wrap gap-1">
                        ...
                        {location.paymentsAccepted.length > 2 && (
                          <span className="text-xs text-gray-500">
                            +{location.paymentsAccepted.length - 2} más
                          </span>
                        )}
                      </div>
                    )}
